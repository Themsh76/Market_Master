    ...
    private void Update()   
    {
        ...
        if (Input.GetMouseButtonDown(0) && buildingToPlace != null)     //Schaut ob die linke Maustaste gedrückt ist und ob ein Haus gerade platziert werden soll
        {
            ...
            foreach (Tile tile in tiles)    // Schleife die schaut welches Feld am nahsten ist
            {
                ...
                if (distance < shortestDistance)    // Schaut ob das nächste Feld in der Schleife näher ist als das zuvor
                {
            ...
            if (nearestTile.isOccupied == false)    // Schaut, ob das nahste Feld beim Klick nicht befüllt ist
            {
